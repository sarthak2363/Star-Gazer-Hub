...
const CLIENT_LOGOS = [
  {
    name: "TechCorp",
    logo: "https://placehold.co/200x100/020617/ffffff?text=TechCorp",
  },
  {
    name: "InnovateX",
    logo: "https://placehold.co/200x100/020617/ffffff?text=InnovateX",
  },
  {
    name: "GlobalSys",
    logo: "https://placehold.co/200x100/020617/ffffff?text=GlobalSys",
  },
  {
    name: "ApexSolutions",
    logo: "https://placehold.co/200x100/020617/ffffff?text=Apex",
  },
];
          ...
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2">
            {images.map((_, i) => (
              <button
                ...
                className={`w-2 h-2 rounded-full transition-all ${i === currentIndex ? "bg-blue-400 w-6" : "bg-white/30 hover:bg-white/50"}`}
              />
            ))}
          </div>
        </>
    ...
    <div className="min-h-screen bg-[#020617] text-white selection:bg-blue-500/30">
      ...
      <div className="relative pt-32 pb-24 overflow-hidden min-h-[60vh] flex items-center justify-center">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            <h1 className="text-4xl md:text-7xl font-display font-bold mb-2 tracking-tight uppercase">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {CORPORATE_OFFERS.map((offer, idx) => (
            <motion.div
              ...
              onClick={() =>
                setExpandedOffer(expandedOffer === idx ? null : idx)
              }
            >
              <div className="p-8">
                    ...
                    >
                      <div className="pt-4 border-t border-white/10 space-y-3">
                        ...
                        <div className="flex items-center gap-2 text-sm">
                          ...
                          <span>
                            <strong>Group Size:</strong> {offer.groupSize}
                          </span>
                        </div>
                        ...
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            window.open(
                              "https://wa.me/917666519425?text=I'm interested in " +
                                offer.title,
                              "_blank",
                            );
                          }}
                ...
                <div className="mt-4 flex justify-center">
                  <ChevronDown
                    className={`w-6 h-6 text-white/30 transition-transform ${expandedOffer === idx ? "rotate-180" : ""}`}
                  />
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-20 bg-white/[0.02]">
        <div className="container mx-auto px-4 text-center max-w-4xl">
          ...
          <p className="text-lg text-white/70 leading-relaxed italic">
            Stargazing is magical at any age, but AstroParty is rare. Guided by
            experts and powered by a 12-inch primary mirror telescope, we bring
            planets, galaxies, and deep-sky wonders to life under truly dark
            skies.
          </p>
          <p className="text-lg text-white/70 leading-relaxed italic">
            It is curated by Aeronautics and Space Exploration (AXSX), working
            in astronomy and space science since 2010. Brought to you by
            AXCamps, a dedicated division for outdoor stargazing experiences,
            corporate events, and school astronomy programs.
          </p>
        </div>
      </section>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/60">
                    The vastness of the sky helps put stressors into
                    perspective, promoting calm and clarity.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/60">
                    Reconnect with the rhythmic patterns of our planet and the
                    cosmos.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/60">
                    A shared astronomical discovery creates lasting memories and
                    stronger interpersonal ties.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/60">
                    Stand out from traditional off-sites with an experience that
      ...
      <section className="py-20 container mx-auto px-4 max-w-4xl">
        <div className="bg-white/5 border border-white/10 rounded-[2rem] p-8 md:p-12">
          ...
          >
            <div className="space-y-2">
              <label className="text-xs uppercase tracking-widest text-white/40 ml-4">
                Full Name
              </label>
              <input
                type="text"
                className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 focus:border-blue-500 outline-none transition-colors"
              />
            </div>
            <div className="space-y-2">
              <label className="text-xs uppercase tracking-widest text-white/40 ml-4">
            ...
            <div className="md:col-span-2 space-y-2">
              ...
              <textarea
                rows={4}
                className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 focus:border-blue-500 outline-none transition-colors resize-none"
              ></textarea>
            </div>
