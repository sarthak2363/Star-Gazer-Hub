...
const teamMembers = [
  ...
  {
    name: "Ekansh Tardeja ",
    role: "Astro Photographer & Astro Guide",
    ...
    <div className="min-h-screen bg-[#0a0c10] text-white">
      ...
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            <span className="text-blue-400 font-display font-bold tracking-[0.3em] uppercase text-sm mb-4 block">
              Our Story
            </span>
            ...
            <p className="text-xl text-blue-100/80 max-w-2xl mx-auto leading-relaxed">
              AXCamps is a division of AXSX, dedicated to bringing the wonders
              of space and aeronautics closer to the curious minds of today.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-display font-bold text-white leading-tight uppercase">
                Pioneering <span className="text-blue-400">Astro-Tourism</span>{" "}
                in India
              </h2>
              <p className="text-white/60 text-lg leading-relaxed">
                AXCamps (Axploration Camps) started with a simple vision: to
                make astronomy and aeronautics accessible to everyone. From
                high-altitude stargazing in Ladakh to wildlife-astro tours in
                Pench, we create experiences that blend science with adventure.
              </p>
            </motion.div>
            ...
            >
              <div className="space-y-4">
                <div className="p-6 bg-white/5 rounded-3xl border border-white/10 group hover:border-purple-500/50 transition-colors">
                  ...
                  <p className="text-white/40 text-sm">
                    To be India's leading platform for astro-tourism,
                    aeromodelling, and experiential science education.
                  </p>
                </div>
              </div>
              <div className="space-y-4 pt-12">
                <div className="p-6 bg-white/5 rounded-3xl border border-white/10 group hover:border-blue-500/50 transition-colors">
                  ...
                  <p className="text-white/40 text-sm">
                    To inspire the next generation of space explorers through
                    hands-on learning and immersive stargazing experiences.
                  </p>
                </div>
              </div>
            </motion.div>
          ...
          <div className="text-center mb-16">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-display font-bold uppercase mb-4 tracking-tighter">
                AXplorers - The{" "}
                <span className="text-blue-500">Axploration</span> Family
              </h2>
              <div className="w-24 h-1 bg-blue-600 mx-auto rounded-full mb-8" />
              <p className="text-white/60 max-w-2xl mx-auto">
                Meet the passionate individuals dedicated to bringing the stars
                closer to you. Our team of educators, astronomers, and adventure
                specialists.
              </p>
            </motion.div>
          </div>
          ...
          {[
            {
              ...
              desc: "We don't just show, we explain. Every program is designed to spark questions and curiosity.",
            },
            {
              title: "Safety First",
              desc: "High altitudes or wildlife zones, your safety is our top priority with professional guides.",
            },
            {
              title: "Community Driven",
              desc: "Building a network of amateur astronomers and aeromodellers across India.",
            },
          ].map((v, i) => (
            <motion.div
              key={i}
            ...
            >
              <div className="text-blue-500 text-5xl font-display font-bold mb-6 opacity-20">
                {i + 1}
              </div>
