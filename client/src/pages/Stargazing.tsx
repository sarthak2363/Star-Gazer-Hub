...
export default function Stargazing() {
  ...
  const highlights = [
    ...
    },
    {
      ...
      title: "Facilities",
      desc: "Well Maintained Hygiene and Cleanliness",
    },
    {
      icon: <Music className="w-6 h-6 text-orange-400" />,
      title: "Jamming",
      desc: "Cozy musical evening under the stars.",
    },
    {
      icon: <Flame className="w-5 h-5 text-orange-400" />,
      title: "Bonfire",
      desc: "A warm bonfire to unwind under the open sky.",
    },
    {
      icon: <Mountain className="w-5 h-5 text-teal-400" />,
      title: "Trek",
      desc: "A gentle trek as the sun rises and nature wakes up.",
    },
  ];
  ...
  const timeline = [
    ...
    { time: "1:00 AM – 5:00 AM", event: "Break for Sleep" },
    {
      ...
      event:
        "Session 3: Morning Object Watching – Witness New Constellation and celestial objects",
    },
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white selection:bg-cyan-500/30">
      ...
      <motion.div
        ...
        whileInView={{ opacity: 1, scale: 0.90 }}
        viewport={{ once: true }}
      >
          ...
          <div className="lg:col-span-7 space-y-12">
            ...
            <div className="bg-white/5 border-l-4 border-cyan-500 p-6 rounded-r-xl">
              <p className="italic text-white/80 m-0 text-left">
                ...
                the universe, our solar family, Indian ancient astronomy, and
                mid-night discussions on the future of astronomy and humanity."
              </p>
            </div>
            ...
            >
              <h3 className="text-2xl font-display font-bold mb-6 flex items-center gap-3">
                <Calendar className="w-6 h-6 text-purple-400" /> Check In Date &
                Time
              </h3>
              <p className="text-white/70 mb-6 text-left">
                Every month, Overnight Sky Watching Session is held on a
                Saturday close to the New Moon, just 35 kilometres from Pune.
              </p>
            ...
            >
              <h3 className="text-2xl font-display font-bold mb-6 flex items-center gap-3">
                <Telescope className="w-6 h-6 text-yellow-400" /> Stargazing
                Astro Party Equipment
              </h3>
              ...
              >
                ...
                <div className="space-y-6 mb-8">
                  <div className="flex justify-between items-center p-4 bg-white/5 rounded-2xl border border-white/5">
                    ...
                    <span className="text-xs text-cyan-400 font-bold bg-cyan-400/10 px-2 py-1 rounded">
                      Per Participant
                    </span>
                  </div>
                  <div className="flex justify-between items-center p-4 bg-white/5 rounded-2xl border border-white/5">
                ...
                <div className="space-y-4 mb-8">
                  ...
                  <div className="flex items-center gap-3 text-white/70">
                    ...
                    <span className="text-sm">Special Couple Offers</span>
                  </div>
                  <div className="flex items-center gap-3 text-white/70">
                  ...
                  <div className="flex items-center gap-3 text-white/70">
                    ...
                    <span className="text-sm">Early Bird Offer</span>
                  </div>
                </div>
